                                ...
                                @isset($posts)
                                    @foreach($posts as $post)
                                        <tr>
                                            ...
                                            <form action="{{ route('post.destroy', $post->id) }}" method="post" id="deleteForm{{$post->id}}">
                                                @csrf
                                                @method('DELETE')
                                                <button type="button" class="btn btn-danger m-1" onclick="confirmDelete({{$post->id}})"><i class="bi bi-trash-fill"></i></button>
                                            </form>
